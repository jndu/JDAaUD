...
namespace structures
{
	...
	/// <summary> Vymenovany typ_ predstavujuci typy dat, ktore mozu byt ulozene v elemente grafu. </summary>
	...
	public:
		...
		/// <param name = "dataType"> Typ dat - data vrcholu alebo data hrany. </param>
		/// <param name = "key"> Jedinecny identifikator dat. Jedna sa u adresu triedy, z ktorej vznikla instancia dat. </param>
		/// <exception cref="std::logic_error"> Vyhodena, ak uz je v grafe registrovany dany typ_ dat s danym klucom. </exception>
		/// <remarks> V ramci metody sa vola nad parametrom key metoda getClassKey(). </remarks>
		...
		/// <param name = "dataType"> Typ dat - data vrcholu alebo data hrany. </param>
		/// <param name = "key"> Jedinecny identifikator dat. Jedna sa u adresu triedy, z ktorej vznikla instancia dat. </param>
		/// <exception cref="std::logic_error"> Vyhodena, ak v grafe nie je registrovany dany typ_ dat s danym klucom. </exception>
		/// <remarks> 
		///	V ramci metody sa vola nad parametrom key metoda getClassKey().
		/// Metoda odstrani dany typ_ dat s danym klucom zo vsetkych elementov grafu, ktore ich mozu obsahovat.
		///	</remarks>
